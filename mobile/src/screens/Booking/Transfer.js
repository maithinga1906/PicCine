    ...
    <ScrollView>
      <View style={{ marginLeft: 15, marginRight: 15, marginBottom: 15,marginTop:15 }}>
        <View style={styles.content}>
          <Image source={require('../../assets/Images/icon/momo.png')}></Image>
          <View>
        ...
        <ScrollView horizontal={true}>
          <View style={styles.content1}>
            <Text style={{fontSize:16,textAlign:'center'}}>Giảm <Text style={{color:'yellow'}}>25%</Text> khi thành toán Online </Text>
          </View>
          <View style={styles.content1}>
            <Text style={{fontSize:16,textAlign:'center'}}>Có cơ hội trợ thành khách hàng Vip</Text>
          </View>
        </ScrollView>
        <View style={styles.content}>
