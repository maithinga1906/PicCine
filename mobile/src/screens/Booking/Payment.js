      ...
      <View style={{ marginLeft: 15, marginRight: 15, marginBottom: 15 }}>
        ...
        <View style={styles.section}>
          <View style={styles.small_content}>
            ...
            <Image style={{ color: 'red', marginLeft: 140 }} source={require('../../assets/Images/icon/la_pen.png')} />
          </View>
          <View style={styles.small_content}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.small_content}>
            <TouchableOpacity style={{flexDirection:'row'}} onPress={() => NavigationUtils.TransferContent()}>
        ...
        <View style={styles.promotion}>
          ...
          <TextInput style={{ backgroundColor: '#C4C4C4', margin: 15, width: screenWidth / 1.8 }} placeholder='Nhập mã giảm giá'></TextInput>
        </View>
        <View style={styles.small_content}>
